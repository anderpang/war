 ...
 */
 init:function(sc:BABYLON.Scene,_displayPanel:any){    
    ...
    // 强我中华
    let door=sc.getMeshByUniqueID(754)!;
   ...
   let houseBox=BABYLON.MeshBuilder.CreateBox("house-box-11",{width:500,height:780,depth:1000*0.87},sc);
    houseBox.position.set(-575,0,2942);
    // houseBox11.visibility=0.5;
